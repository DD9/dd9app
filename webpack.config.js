...
// This is our JavaScript loader that specifies what to do with .js files
const javascript = {
  test: /\.(js)$/, // We regex match anything that ends in `.js`
  use: [{
    loader: 'babel-loader',
...
const config = {
  entry: {
    ...
    App: './public/javascripts/app-entry.js'
  },
